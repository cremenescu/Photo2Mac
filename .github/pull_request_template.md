...
<!-- Did you actually run the app and try it? Don't just say "looks good".
     If the change touches the editor pipeline, list the formats and image
     sizes you tested. -->

- macOS version:
- Tested formats / scenarios:
- Steps to verify:
...
- [ ] If this changes the `.dmg`, I rebuilt it with `./build/package.sh` and verified the bundle is well-formed.
