# Contributing to Photo2Mac

Thanks for your interest! Photo2Mac is an alpha-stage native macOS
image editor with a non-destructive editing model (operations live in
an `EditStack` and are persisted into the image's XMP metadata). Help
is welcome.
...
- the Photo2Mac version (Help > About Photo2Mac);
...
`~/Library/Logs/DiagnosticReports/Photo2Mac_*.ips`.
